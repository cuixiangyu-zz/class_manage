  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/manage/recruitmentInformation/list",
          delete: "/manage/recruitmentInformation/delete",
          deleteBatch: "/manage/recruitmentInformation/deleteBatch",
          exportXlsUrl: "/manage/recruitmentInformation/exportXls",
          importExcelUrl: "manage/recruitmentInformation/importExcel",
        },
        dictOptions:{},
      }
    },
