  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/manage/activity/list",
          delete: "/manage/activity/delete",
          deleteBatch: "/manage/activity/deleteBatch",
          exportXlsUrl: "/manage/activity/exportXls",
          importExcelUrl: "manage/activity/importExcel",
        },
        dictOptions:{},
      }
    },
