<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('学院班级表')">导出</a-button>
    ...
    <collegeClass-modal ref="modalForm" @ok="modalFormOk"></collegeClass-modal>
  </a-card>
</template>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/manage/collegeClass/rootList",
          childList: "/manage/collegeClass/childList",
          delete: "/manage/collegeClass/delete",
          deleteBatch: "/manage/collegeClass/deleteBatch",
          exportXlsUrl: "/manage/collegeClass/exportXls",
          importExcelUrl: "manage/collegeClass/importExcel",
        },
        expandedRowKeys:[],
