    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="学年" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-dict-select-tag @change="changeXn" type="list" v-decorator="['xn']" :triggerChange="true" placeholder="请输入学年"
                             dictCode="entrance_year"/>
        </a-form-item>
        <a-form-item label="学期" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-dict-select-tag @change="changeXq" type="list" v-decorator="['xq']" :triggerChange="true" placeholder="请输入学期"
                             dictCode="xq"/>
        </a-form-item>
