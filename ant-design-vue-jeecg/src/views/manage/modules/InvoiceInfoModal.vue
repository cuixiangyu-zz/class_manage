  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/manage/invoiceInfo/add",
          edit: "/manage/invoiceInfo/edit",
        }
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'name','file','money'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'name','file','money'))
      },
