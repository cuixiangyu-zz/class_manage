  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/manage/employmentAgreement/add",
          edit: "/manage/employmentAgreement/edit",
        }
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'type','file'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'type','file'))
      },
