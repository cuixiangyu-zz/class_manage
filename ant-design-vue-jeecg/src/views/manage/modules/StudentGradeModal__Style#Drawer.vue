  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/manage/studentGrade/add",
          edit: "/manage/studentGrade/edit",
        }
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'studentId','xn','xq'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'studentId','xn','xq'))
      }
