    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="学院" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="['institute']" placeholder="请输入学院"></a-input>
        </a-form-item>
        <a-form-item label="专业" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="['major']" placeholder="请输入专业"></a-input>
        </a-form-item>
        <a-form-item label="班级" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="['class']" placeholder="请输入班级"></a-input>
        </a-form-item>
