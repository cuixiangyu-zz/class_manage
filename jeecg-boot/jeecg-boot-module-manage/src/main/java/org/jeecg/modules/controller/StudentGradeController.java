...
public class StudentGradeController extends JeecgController<StudentGrade, IStudentGradeService> {
    ...
    public Result<?> getGradeList(String studentId, String xq, String xn) {
        return studentGradeService.getGradeList(studentId, xq, xn);
    }

    @GetMapping(value = "/calculateGrade")
    public Result<?> calculateGrade(String studentId, String xq, String xn) {
        return studentGradeService.calculate(studentId, xq, xn);
    }
}
